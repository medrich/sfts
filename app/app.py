...
with open('/home/mattiboi/Desktop/Data Science/Metis/Engineering/project/data/genres.p', 'rb') as fp:
    genres = pickle.load(fp)

with open('/home/mattiboi/Desktop/Data Science/Metis/Engineering/project/data/genres_clean.p', 'rb') as fp:
    genres_clean = pickle.load(fp)
    
with open('/home/mattiboi/Desktop/Data Science/Metis/Engineering/project/data/artists_clean.p', 'rb') as fp:
